...
### SoundPrint
An in-progress Spotify analytics project that analyzes listening patterns and generates AI-powered taste summaries and artist recommendations.
...
- Tracks exercise-specific metrics like volume, max weight, and estimated 1RM
- Uses moving averages to smooth progress trends
- Implements simple least-squares linear regression from scratch for forecasting
- Uses Gemini to generate workout insights from performance metrics and notes
...
Python, Java, C/C++, TypeScript, React, FastAPI, Streamlit, Pandas, NumPy, Plotly, Pytest, Git
